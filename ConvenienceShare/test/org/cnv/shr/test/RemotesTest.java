...
public class RemotesTest extends LocalMachineTest
{
	...
	@BeforeClass
	public static void createRemotes() throws IOException
	{
		infos = new MachineInfo[2];
		infos[0] = new MachineInfo(".." + File.separator + "instances" + File.separator + "instance1", 7990, "clOvFbFlEEDh0sfCQieGwbwCv2E6T9sBarPnJ0UV52zb8XDn1f");
		infos[1] = new MachineInfo(".." + File.separator + "instances" + File.separator + "instance2", 8990, "KroGnSns2whGXu5ihtxlgjdr8Xg4YxuJjS5oKsq2DS8NeLn046");
	}
