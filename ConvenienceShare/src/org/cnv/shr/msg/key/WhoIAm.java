	...
	public void parse(JsonParser parser) {       
		...
		while (parser.hasNext()) {                 
			...
			case END_OBJECT:                         
				if (needsPKey)
				{
					throw new javax.json.JsonException("Incomplete json: type=\"org.cnv.shr.msg.key.WhoIAm\" needs \"pKey\"");
				}
				if (needsVersionString)
				{
					throw new javax.json.JsonException("Incomplete json: type=\"org.cnv.shr.msg.key.WhoIAm\" needs \"versionString\"");
				}
				if (needsIp)
				{
