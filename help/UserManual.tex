...
First:
\begin{itemize}
\item connection statistics need to work
...
\item make tracker gui a parameter
\item make parameter for tracker gui to not store file metadata
\item make urls bigger: tracker, machine, update
\item don't start tracker if already started
\end{itemize}
Later:
\begin{itemize}
\item finish getLogs
